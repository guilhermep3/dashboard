      ...
      <div className="p-5 w-full max-w-[1200px] mx-auto">
         ...
         <div className="grid grid-cols-1">
            <div className="grid items-start grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
               ...
               {isLoading ? <Skeleton h="300px" /> : <BarChartComponent products={chartData} />}
            </div>
         </div>
      </div>
   );
...
//          // Função para agrupar os produtos por mês
//          setProductsByMonth(groupByMonth(formattedData));


//          console.log("productsByMonth: ", productsByMonth)
//          // 2025-04-01T00:50:37.548439+00:00
//          setProducts(formattedData);
//       } catch (error: any) {
//          console.error("Erro ao buscar produtos:", error);
//       }
...
//    // flex flex-wrap justify-center sm:justify-start items-start gap-5
//    return (
//       <div className="p-5 w-full max-w-[1200px] mx-auto">
//          <h1 className="mb-5">Dashboard</h1>
//          <div className="grid grid-cols-1">
...
//                   <Skeleton h="300px" />
//                ) : (
//                   <BarChartComponent products={productsByMonth} />
//                )}
//             </div>
//          </div>
//       </div>
...
// preciso guardar o valor de formatChartData em uma state e passar para BarChartComponent